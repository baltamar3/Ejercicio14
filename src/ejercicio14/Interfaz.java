...
public class Interfaz extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtDias, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 60, -1));

        jLabel3.setText("Costo de las estadia: ");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 130, -1, -1));

        txtCosto.setEditable(false);
        jPanel1.add(txtCosto, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 150, 240, -1));
        ...
        jPanel1.add(cmdBorrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 230, -1, -1));
    ...
    private void cmdCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdCalcularActionPerformed
       ...
       String costo_total;
        ...
        if(txtDias.getText().trim().isEmpty()){
            JOptionPane.showMessageDialog(this,"Ingrese el numero de dias que desea hospedarse en el hotel"," error", JOptionPane.INFORMATION_MESSAGE);
            txtDias.requestFocusInWindow();
        }
       else{
           dias=Double.parseDouble(txtDias.getText());
           costo=(dias*200000)-100000;
           
           costo_total=String.valueOf(costo);
